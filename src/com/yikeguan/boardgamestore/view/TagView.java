...
public class TagView extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		for (int i = 0; i < count; i++) {
			...
			if (w > VIEW_WIDTH - 10) {
				...
				int ww = MeasureSpec.makeMeasureSpec(VIEW_WIDTH,
						MeasureSpec.AT_MOST);
				int hh = MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(),
	 ...
	 * @param iv
	 */
	public void addView(final TagNameView nameView, final int which) {
		final View gView = nameView.getView();
