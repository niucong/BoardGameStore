...
import com.yikeguan.boardgamestore.adapter.FaceAdapter;
...
public class FacesView extends RelativeLayout {
	...
	int rows = 3;
	int liesInPage = 8;
	int[] res = FaceUtil.FACE_RES_DIDS;
	String[] texts = FaceUtil.FACE_DTEXTS;
	...
	public void setRes(int[] res, String[] texts) {
		this.res = res;
		this.texts = texts;
	}
