...
public class RecommendFindListParams extends BasicParams {
	 ...
	 * @param id
	 */
	public RecommendFindListParams(Context context, String id, String start,
			String limit) {
		super(context);
	...
	private void setVariable(String id, String start, String limit) {
		paramsMap.put("method", "find_recommend_list");
