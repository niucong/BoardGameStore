...
public class RecommendDeleteParams extends BasicParams {
	 ...
	 * @param id
	 */
	public RecommendDeleteParams(Context context, String id) {
		super(context);
		setVariable(id);
	}

	private void setVariable(String id) {
		paramsMap.put("method", "delete_recommend_info");
		paramsMap.put("id", id);
