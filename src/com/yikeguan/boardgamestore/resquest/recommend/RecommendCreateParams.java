...
public class RecommendCreateParams extends BasicParams {
	 ...
	 * @param files
	 */
	public RecommendCreateParams(Context context, String obj_name,
	...
	private void setVariable(String obj_name, String obj_desc, String[] photos,
			String[] files) {
		paramsMap.put("method", "create_recommend");
