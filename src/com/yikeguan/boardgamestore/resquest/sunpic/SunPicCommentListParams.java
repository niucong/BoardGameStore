...
public class SunPicCommentListParams extends BasicParams {
	 ...
	 * @param id
	 */
	public SunPicCommentListParams(Context context, String id) {
		super(context);
		setVariable(id);
	}

	private void setVariable(String id) {
		paramsMap.put("method", "comment_sunpic_list");
		paramsMap.put("id", id);
