...
public class SunPicDeleteCommentParams extends BasicParams {
	 ...
	 * @param id
	 */
	public SunPicDeleteCommentParams(Context context, String id) {
		super(context);
		setVariable(id);
	}

	private void setVariable(String id) {
		paramsMap.put("method", "delete_comment_sunpic_info");
		paramsMap.put("id", id);
