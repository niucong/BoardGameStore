...
public class GroupFindListParams extends BasicParams {
	 ...
	 * @param id
	 */
	public GroupFindListParams(Context context, String id, String start,
			String limit) {
		super(context);
	...
	private void setVariable(String id, String start, String limit) {
		paramsMap.put("method", "find_group_list");
