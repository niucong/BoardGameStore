...
public class GetMemberBasicParams extends BasicParams {
	 ...
	 * @param member_id 可选项
	 */
	public GetMemberBasicParams(Context context, String member_id) {
		super(context);
		setVariable(member_id);
	}

	private void setVariable(String member_id) {
		paramsMap.put("method", "get_member_basic");
	...
	public String getParams() {
		L.i(TAG, "GetMemberBasicParams strParams=" + strParams);
		return strParams;
	}
	...
	public ResultModel getResult() throws KeyManagementException,
		...
		String str = HttpRequestServers.getRequest(ConstantUtil.API_URL
				+ "member", getParams());
		L.i(TAG, "GetMemberBasicParams str=" + str);
