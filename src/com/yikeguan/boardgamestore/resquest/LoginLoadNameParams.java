...
public class LoginLoadNameParams extends BasicParams {
	 ...
	 * @param password
	 */
	public LoginLoadNameParams(Context context, String loadName, String password) {
		super(context);
		setVariable(loadName, password);
	}

	private void setVariable(String loadName, String password) {
		paramsMap.put("method", "log_by_loadName");
