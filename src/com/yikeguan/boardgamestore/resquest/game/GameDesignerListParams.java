...
public class GameDesignerListParams extends BasicParams {
	 ...
	 *            可选项
	 */
	public GameDesignerListParams(Context context, String order, String start,
			String limit) {
		super(context);
	...
	private void setVariable(String order, String start, String limit) {
		paramsMap.put("method", "game_designer_list");
