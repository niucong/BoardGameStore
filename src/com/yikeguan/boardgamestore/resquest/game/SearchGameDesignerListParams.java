...
public class SearchGameDesignerListParams extends BasicParams {
	 ...
	 *            可选项
	 */
	public SearchGameDesignerListParams(Context context, String id,
	...
	private void setVariable(String id, String start, String limit) {
		paramsMap.put("method", "search_game_designer_list");
		paramsMap.put("id", id);
	...
	public String getParams() {
		L.i(TAG, "SearchGameDesignerListParams strParams=" + strParams);
		return strParams;
	}
	...
	public ResultModel getResult() throws KeyManagementException,
		...
		String str = HttpRequestServers.getRequest(ConstantUtil.API_URL
				+ "game", getParams());
		L.i(TAG, "SearchGameDesignerListParams str=" + str);
