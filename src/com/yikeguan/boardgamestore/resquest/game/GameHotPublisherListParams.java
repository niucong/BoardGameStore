...
public class GameHotPublisherListParams extends BasicParams {
	 ...
	 *            可选项
	 */
	public GameHotPublisherListParams(Context context, String order,
	...
	private void setVariable(String order, String start, String limit) {
		paramsMap.put("method", "game_hot_publisher_list");
